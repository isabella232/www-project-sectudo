    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tpn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(SecCheckEligibilityActivity.this, MainNewActivity.class).putExtra("irs","back"));
            }});
        ImageView bck;
        ...
        bck.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(SecCheckEligibilityActivity.this, LearningTabActivity.class).putExtra("topic",topic));
            }});
