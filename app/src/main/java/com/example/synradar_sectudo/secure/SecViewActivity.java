...
public class SecViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Toast.makeText(SecViewActivity.this, topic, Toast.LENGTH_LONG).show();
        ...
        tpn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(SecViewActivity.this, MainNewActivity.class).putExtra("irs","back"));
            }});
        ImageView bck;
        ...
        bck.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(SecViewActivity.this, LearningTabActivity.class).putExtra("topic",topic));
            }});
        try {
        ...
        topicName = (TextView) findViewById(R.id.textView32);
        switch (topic){
            case "xss":
