...
public class InsShowDetailsActivity extends AppCompatActivity {
    ...
    private class GetAcctTask extends AsyncTask<String,String,String>{
        ...
        protected String doInBackground(String... strs){
            ...
            URL url;
            try {
                url = new URL(Constants.getAcctURL+ strs[0]+"/"+strs[1]);





                String param = EncryptionUtil.AsymEncrypt(strs[2]);
        ...
        btnshow_details.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    String opStr = task.execute(topic, acct_id, rndtoken ).get();
                    ...
                    String act_nmb = jsonObj.getString("account_id");



                    String encstatus = jsonObj.getString("status");
                    String status = EncryptionUtil.symDecrypt(encstatus,rndtoken);
                    if("true".equals(status)) {
                        startActivity(new Intent(InsShowDetailsActivity.this, CongratsActivity.class).putExtra("topic", topic).putExtra("act_nmb",act_nmb).putExtra("actname", act_name).putExtra("actbalance", act_balance));
                    }
                    else{
                        startActivity(new Intent(InsShowDetailsActivity.this, RetryActivity.class).putExtra("topic", topic).putExtra("act_nmb",act_nmb).putExtra("actname", act_name).putExtra("actbalance", act_balance));
                    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tpn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(InsShowDetailsActivity.this, MainNewActivity.class).putExtra("irs","back"));
            }});
        ImageView bck;
        ...
        bck.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(InsShowDetailsActivity.this, LearningTabActivity.class).putExtra("topic",topic));
            }});
        ...
        ImageView imgbtn;
        imgbtn = (ImageView) findViewById(R.id.imageView32);
        ...
        vi = (ImageView) findViewById(R.id.imageView126);
        topicName = (TextView) findViewById(R.id.textView34);
        switch (topic){
            case "sqli":
                topicName.setText(("Task for Server Side - SQL Injection Attack"));
                vi.setImageResource(R.drawable.sqlee);
                break;
            case "ida":
                topicName.setText(("Task for Insecure Data Access"));
                vi.setImageResource(R.drawable.ia5);
                break;
        }
    }
